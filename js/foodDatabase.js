...
const FoodDB = (() => {
  ...
  const ENTRIES = [
    ...
    { names:['semolina upma','suji upma'], cat:'breakfast', portion:'1 bowl (150g)', calories:220, protein:5, carbs:32, fat:8 },
    ...
    { names:['paratha (butter)','butter paratha'], cat:'breakfast', portion:'1 piece (65g)', calories:296, protein:4, carbs:32, fat:17 },
    ...
    { names:['puttu','puttu kerala'], cat:'breakfast', portion:'1 piece (50g)', calories:70, protein:1.5, carbs:15, fat:0.2 },
    { names:['appam'], cat:'breakfast', portion:'1 piece (40g)', calories:60, protein:1, carbs:13, fat:0.7 },
    { names:['ragi porridge'], cat:'breakfast', portion:'1 bowl (150g)', calories:160, protein:4, carbs:28, fat:3 },
    ...
    { names:['makki roti'], cat:'breakfast', portion:'1 piece (40g)', calories:90, protein:2.5, carbs:16, fat:1.5 },
    { names:['uthappam'], cat:'breakfast', portion:'1 piece (50g)', calories:90, protein:2, carbs:16, fat:1.5 },
    ...
    { names:['egg bhurji'], cat:'breakfast', portion:'2 eggs + 1 tsp oil', calories:196, protein:12.6, carbs:1.2, fat:15.1 },
    { names:['soya egg bhurji'], cat:'breakfast', portion:'1 large bowl (50g soya + 2 eggs)', calories:280, protein:26, carbs:6, fat:16 },
    { names:['egg white (boiled)','egg white','boiled egg white'], cat:'breakfast', portion:'1 large (33g)', calories:17, protein:3.6, carbs:0.2, fat:0 },
    { names:['gulab jamun'], cat:'breakfast', portion:'1 piece (25g)', calories:90, protein:1, carbs:14, fat:3.5 },
    ...
    // --- Lunch / Dinner ---
    { names:['roti (plain wheat/dry)','roti','chapati','phulka','fulka','dry roti'], cat:'lunch_dinner', portion:'1 medium (40g)', calories:105, protein:3.5, carbs:22, fat:0.5 },
    { names:['roti (wheat with butter)','butter roti'], cat:'lunch_dinner', portion:'1 medium (40g + 5g butter)', calories:141, protein:3.5, carbs:22, fat:4.5 },
    { names:['roti (wheat with ghee)','ghee roti'], cat:'lunch_dinner', portion:'1 medium (40g + 5g ghee)', calories:150, protein:3.5, carbs:22, fat:5.5 },
    ...
    { names:['biryani rice base'], cat:'lunch_dinner', portion:'1 cup (180g)', calories:190, protein:4, carbs:42, fat:1 },
    ...
    { names:['dal (thick)','dal','toor dal','arhar dal','dal fry'], cat:'lunch_dinner', portion:'1 bowl (150g)', calories:150, protein:9, carbs:24, fat:2 },
    { names:['dal (thin/watery)','thin dal','dal paani'], cat:'lunch_dinner', portion:'1 bowl (150g)', calories:80, protein:4.5, carbs:14, fat:1 },
    { names:['arhar dal tadka'], cat:'lunch_dinner', portion:'1 bowl (150g)', calories:160, protein:10, carbs:26, fat:2.5 },
    ...
    { names:['chole bhature'], cat:'lunch_dinner', portion:'1 piece (150g)', calories:380, protein:12, carbs:52, fat:14 },
    ...
    { names:['tandoori paneer'], cat:'lunch_dinner', portion:'100g', calories:220, protein:20, carbs:2, fat:15 },
    { names:['air-fried crispy paneer (peri-peri)','air fried paneer'], cat:'lunch_dinner', portion:'100g + drops of mustard oil', calories:270, protein:18, carbs:2, fat:21 },
    ...
    { names:['aloo bhujia (crispy/mustard oil)','aloo bhujia'], cat:'lunch_dinner', portion:'1 bowl (150g)', calories:220, protein:3, carbs:22, fat:13 },
    ...
    { names:['broccoli sabji'], cat:'lunch_dinner', portion:'1 bowl (150g)', calories:120, protein:5, carbs:18, fat:3 },
    { names:['mushroom do pyaza'], cat:'lunch_dinner', portion:'1 bowl (150g)', calories:140, protein:6, carbs:14, fat:6 },
    { names:['sarson ka saag'], cat:'lunch_dinner', portion:'1 bowl (150g)', calories:140, protein:6, carbs:12, fat:7 },
    { names:['lobia masala'], cat:'lunch_dinner', portion:'1 bowl (150g)', calories:200, protein:11, carbs:30, fat:4 },
    { names:['methi thepla'], cat:'lunch_dinner', portion:'1 piece (40g)', calories:100, protein:2.5, carbs:14, fat:3.5 },
    { names:['puri sabji'], cat:'lunch_dinner', portion:'2 puri + 1 bowl sabji (200g)', calories:380, protein:8, carbs:48, fat:18 },
    ...
    { names:['roasted chana (dry)','roasted chana'], cat:'lunch_dinner', portion:'1 small bowl (50g)', calories:185, protein:9, carbs:29, fat:3 },
    ...
    { names:['chicken roti wrap'], cat:'lunch_dinner', portion:'1 dry roti + 75g Tandoori Chicken', calories:230, protein:22, carbs:23, fat:5 },
    ...
    { names:['tandoori fish'], cat:'lunch_dinner', portion:'100g', calories:160, protein:28, carbs:0, fat:5.5 },
    ...
    { names:['litti chokha (air-fried/no ghee)','litti chokha air fried'], cat:'lunch_dinner', portion:'2 littis with chokha (250g)', calories:280, protein:10, carbs:55, fat:4 },

    // --- Bihari Specialties ---
    { names:['baati'], cat:'bihari', portion:'1 piece (60g)', calories:180, protein:4, carbs:28, fat:5 },
    { names:['chikhalwali (bihar style)','chikhalwali'], cat:'bihari', portion:'1 bowl (150g)', calories:200, protein:5, carbs:32, fat:6 },
    { names:['chura ghee'], cat:'bihari', portion:'1 bowl (150g)', calories:290, protein:6, carbs:38, fat:12 },
    { names:['dhal puri'], cat:'bihari', portion:'1 piece (80g)', calories:240, protein:7, carbs:32, fat:9 },
    { names:['khichdi (ghee)','ghee khichdi'], cat:'bihari', portion:'1 bowl (150g)', calories:280, protein:8, carbs:40, fat:10 },
    { names:['litti chokha','litti'], cat:'bihari', portion:'1 litti with chokha (125g)', calories:190, protein:5, carbs:27.5, fat:7 },
    { names:['malaiya (rabri)','malaiya','rabri'], cat:'bihari', portion:'1 small bowl (100g)', calories:180, protein:6, carbs:24, fat:6 },
    { names:['petha (ash gourd candy)','petha'], cat:'bihari', portion:'2 pieces (40g)', calories:100, protein:0.5, carbs:25, fat:0.2 },
    { names:['sattu ke laddoo','sattu laddoo'], cat:'bihari', portion:'1 laddoo (30g)', calories:120, protein:4, carbs:14, fat:5 },
    { names:['sattu paratha'], cat:'bihari', portion:'1 piece (90g)', calories:220, protein:6, carbs:28, fat:9 },
    { names:['sattu sharbat (cold)'], cat:'bihari', portion:'1 glass (250ml)', calories:100, protein:6, carbs:18, fat:1.5 },
    { names:['thekua'], cat:'bihari', portion:'1 piece (25g)', calories:110, protein:1.5, carbs:15, fat:5 },
    { names:['tilkut'], cat:'bihari', portion:'1 piece (25g)', calories:110, protein:2.5, carbs:12, fat:6 },
    ...
    { names:['baked chips (multigrain)','baked chips'], cat:'snack', portion:'1 small bowl (30g)', calories:140, protein:2, carbs:22, fat:4 },
    { names:['chakli'], cat:'snack', portion:'1 piece (16g)', calories:73, protein:1, carbs:8.7, fat:3.7 },
    { names:['murukku'], cat:'snack', portion:'1 piece (16g)', calories:80, protein:1, carbs:9.3, fat:4 },
    { names:['poha chivda'], cat:'snack', portion:'1 small bowl (50g)', calories:200, protein:4, carbs:24, fat:10 },
    { names:['roasted chickpea snack'], cat:'snack', portion:'1 small bowl (40g)', calories:160, protein:8, carbs:18, fat:5 },
    { names:['sprout salad'], cat:'snack', portion:'1 small bowl (100g)', calories:75, protein:5.5, carbs:11, fat:1 },
    { names:['kachumber salad'], cat:'snack', portion:'1 small bowl (100g)', calories:40, protein:1.5, carbs:8, fat:0.3 },
    { names:['dry fruit mix'], cat:'snack', portion:'1 small bowl (30g)', calories:160, protein:5, carbs:12, fat:10 },
    { names:['masala peanuts'], cat:'snack', portion:'1 small bowl (30g)', calories:180, protein:7, carbs:8, fat:14 },
    { names:['jalebi'], cat:'snack', portion:'1 piece (20g)', calories:70, protein:0.8, carbs:15.5, fat:0.8 },
    ...
    { names:['lassi (sweet)','sweet lassi','lassi'], cat:'drink', portion:'1 glass (200ml)', calories:160, protein:6, carbs:24, fat:4 },
    { names:['buttermilk','chaas'], cat:'drink', portion:'1 glass (200ml)', calories:80, protein:6, carbs:10, fat:1 },
    ...
    { names:['almond milk'], cat:'drink', portion:'1 cup (200ml)', calories:80, protein:1, carbs:1, fat:2.5 },
    { names:['warm milk with turmeric','turmeric milk','haldi doodh'], cat:'drink', portion:'1 cup (200ml)', calories:160, protein:8, carbs:14, fat:8 },
    { names:['tea','chai'], cat:'drink', portion:'1 cup (150ml)', calories:60, protein:1.5, carbs:9, fat:2 },
    { names:['masala chai'], cat:'drink', portion:'1 cup (150ml)', calories:80, protein:2, carbs:14, fat:2 },
    ...
    { names:['beetroot juice'], cat:'drink', portion:'1 glass (200ml)', calories:70, protein:1.8, carbs:16, fat:0.2 },
    { names:['vegetable juice'], cat:'drink', portion:'1 glass (200ml)', calories:50, protein:1.5, carbs:10, fat:0.3 },
    { names:['sugarcane juice'], cat:'drink', portion:'1 glass (200ml)', calories:120, protein:0.3, carbs:30, fat:0.2 },
    { names:['coconut water'], cat:'drink', portion:'1 glass (200ml)', calories:90, protein:0.7, carbs:22, fat:0.2 },
    ...
    { names:['whey protein shake'], cat:'drink', portion:'1 scoop with water', calories:130, protein:25, carbs:4, fat:1 },
    ...
    { names:['coconut oil'], cat:'other', portion:'1 tsp (5g)', calories:45, protein:0, carbs:0, fat:5 },
    { names:['sesame oil'], cat:'other', portion:'1 tsp (5g)', calories:45, protein:0, carbs:0, fat:5 },
    ...
    { names:['cumin seeds','jeera'], cat:'other', portion:'1 tsp (5g)', calories:22, protein:1, carbs:2, fat:1.5 },
    { names:['mustard seeds','rai'], cat:'other', portion:'1 tsp (5g)', calories:20, protein:1, carbs:1.5, fat:1.5 },
    { names:['red chili powder','chili powder'], cat:'other', portion:'1 tsp (2g)', calories:8, protein:0.3, carbs:1, fat:0.3 },
    { names:['turmeric powder','haldi'], cat:'other', portion:'1 tsp (3g)', calories:10, protein:0.3, carbs:1.4, fat:0.3 },
  ];
